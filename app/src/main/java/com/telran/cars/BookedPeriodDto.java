...
public class BookedPeriodDto {
    ...
    public BookedPeriodDto(double amount, String booking_date, String end_date_time, String order_id, boolean paid, PersonWhoBookedDto person_who_booked, String start_date_time) {
        this.amount = amount;
