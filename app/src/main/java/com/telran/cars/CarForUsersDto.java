...
public class CarForUsersDto {
    ...
    private BookedPeriodForCarDto[] booked_periods;
    ...
    public CarForUsersDto(String about, BookedPeriodForCarDto[] booked_periods, String car_class, CommentDto comments, double distance_included, int doors, String engine, String[] features, String fuel, float fuel_consumption, String gear, int horsepower, String[] image_url, String make, String model, OwnerDtoForCar owner, PickUpPlaceDto pick_up_place, double price_per_day, int seats, String serial_number, StatisticsDto statistics, int torque, String wheels_drive, String year) {
        this.about = about;
    ...
    public BookedPeriodForCarDto[] getBooked_periods() {
        return booked_periods;
    }

    public void setBooked_periods(BookedPeriodForCarDto[] booked_periods) {
        this.booked_periods = booked_periods;
    }
    ...
    public void setOwner(OwnerDtoForCar owner) {
        this.owner = owner;
    }
